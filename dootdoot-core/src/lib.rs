...
pub use sequence::{
    ...
    role_long_pause_samples, sequence_utterance, staged_reply_rest_samples, syllable_rubato_scale,
    text_syllable_duration_scale,
};
pub use synth::{
    ACCENT_PITCH_SPAN_SEMITONES, ATTACK_TRANSIENT_MIX, ATTACK_TRANSIENT_SECONDS,
    BASE_SYLLABLE_SAMPLES, BASE_SYLLABLE_SECONDS, BODY_LAYER_MIX, CLAUSE_SYLLABLE_SAMPLES,
