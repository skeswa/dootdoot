...
pub use synth::{
    ...
    PORTAMENTO_SECONDS, RING_MOD_FREQUENCY_HZ, RING_MOD_MIX, SOURCE_MAX_HARMONICS,
    SOURCE_PULSE_MIX, SOURCE_PULSE_WIDTH, SOURCE_SAW_MIX, SYNTH_SAMPLE_RATE_HZ, Synth,
    TRAILING_SILENCE_SECONDS, VOWEL_LOCUS_COUNT, WARBLE_DEPTH_CENTS, WARBLE_RATE_HZ,
    WORD_PAUSE_SECONDS, source_harmonic_count, source_oscillator_sample,
};
pub use tokenizer::{
