...
pub use synth::{
    ...
    MEDIUM_PUNCTUATION_PAUSE_SAMPLES, MEDIUM_PUNCTUATION_PAUSE_SECONDS, NOISE_BREATH_MAX_MIX,
    PHRASE_EMPHASIS_GAIN, PHRASE_EMPHASIS_PITCH_SEMITONES, PITCH_REGISTER_BIAS_HZ,
    PITCH_SEMITONE_SPAN, PORTAMENTO_SECONDS, PUNCTUATION_GLIDE_SEMITONES, RING_MOD_FREQUENCY_HZ,
    RING_MOD_MIX, SENTENCE_SYLLABLE_SAMPLES, SOURCE_MAX_HARMONICS, SOURCE_PULSE_MIX,
    SOURCE_PULSE_WIDTH, SOURCE_SAW_MIX, SYNTH_SAMPLE_RATE_HZ, Synth, TRAILING_SILENCE_SAMPLES,
    TRAILING_SILENCE_SECONDS, UPPER_MID_SPARKLE_MIX, VOWEL_LOCUS_COUNT, VOWEL_TRAJECTORY_BLOOM,
    VOWEL_TRAJECTORY_SWEEP, WARBLE_DEPTH_CENTS, WARBLE_DRIFT_RATE_HZ, WARBLE_FLUTTER_RATE_HZ,
    WARBLE_RATE_HZ, WHISTLE_PITCH_CEILING_HZ, WHISTLE_TARGET_HZ, WIDE_GESTURE_PITCH_SPAN_SEMITONES,
    WORD_PAUSE_SAMPLES, WORD_PAUSE_SECONDS, amplitude_envelope, apply_amplitude_envelope,
    apply_internal_pitch_swoop_hz, apply_warble_hz, apply_warble_hz_with_phase,
    attack_transient_sample, blend_noise_excitation, body_layer_frequency_hz, body_layer_sample,
    compound_warble_offset_cents, formant_frequencies, internal_pitch_offset_cents,
    noise_breath_sample, pitch_center_hz, pitch_center_hz_with_span, portamento_pitch_hz,
    portamento_progress, render_syllable, ring_modulate, source_harmonic_count,
    source_oscillator_sample, upper_mid_sparkle_frequency_hz, upper_mid_sparkle_sample,
    vowel_trajectory_position, warble_depth_cents, warble_offset_cents,
    warble_phase_offset_for_syllable, whistle_sweep_pitch_hz,
};
pub use tokenizer::{
