...
pub use synth::{
    ...
    ring_modulate, source_harmonic_count, source_oscillator_sample, upper_mid_sparkle_frequency_hz,
    upper_mid_sparkle_sample, vowel_trajectory_position, warble_depth_cents, warble_offset_cents,
