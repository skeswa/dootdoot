...
pub use format::{
    ...
    FORMAT_V2, FORMAT_VERSION_NUMBER, Format, FormatArtifact, FormatError, FormatSquashFunction,
    SquashAxisStats, embedded_format_v1,
};
pub use mapping::{
...
pub use synth::{
    ...
    apply_warble_hz_with_phase, attack_transient_sample, body_layer_frequency_hz,
    body_layer_sample, compound_warble_offset_cents, formant_frequencies,
