...
pub use synth::{
    ...
    BODY_LAYER_MIX, ENVELOPE_ATTACK_SECONDS, ENVELOPE_DECAY_SECONDS, ENVELOPE_RELEASE_SECONDS,
    ENVELOPE_SUSTAIN_LEVEL, FORMANT_AH_HZ, FORMANT_COUNT, FORMANT_EE_HZ, FORMANT_GAINS,
    FORMANT_OO_HZ, FORMANT_Q, FormantFilterBank, INTERNAL_PITCH_ARCH_CENTS,
    ...
    UPPER_MID_SPARKLE_MIX, VOWEL_LOCUS_COUNT, VOWEL_TRAJECTORY_BLOOM, VOWEL_TRAJECTORY_SWEEP,
    WARBLE_DEPTH_CENTS, WARBLE_DRIFT_RATE_HZ, WARBLE_FLUTTER_RATE_HZ, WARBLE_RATE_HZ,
    ...
    source_harmonic_count, source_oscillator_sample, upper_mid_sparkle_frequency_hz,
