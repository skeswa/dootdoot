...
pub use synth::{
    ...
    WARBLE_DEPTH_CENTS, WARBLE_RATE_HZ, WORD_PAUSE_SAMPLES, WORD_PAUSE_SECONDS, amplitude_envelope,
    apply_amplitude_envelope, apply_internal_pitch_swoop_hz, apply_warble_hz,
    attack_transient_sample, body_layer_frequency_hz, body_layer_sample, formant_frequencies,
