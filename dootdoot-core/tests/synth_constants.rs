...
use dootdoot_core::{
    ...
    FORMANT_COUNT, FORMANT_EE_HZ, FORMANT_GAINS, FORMANT_OO_HZ, FORMANT_Q, LEADING_SILENCE_SAMPLES,
    ...
    TRAILING_SILENCE_SAMPLES, TRAILING_SILENCE_SECONDS, VOWEL_LOCUS_COUNT, WARBLE_DEPTH_CENTS,
    WARBLE_RATE_HZ, WORD_PAUSE_SAMPLES, WORD_PAUSE_SECONDS,
};
