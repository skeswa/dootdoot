...
use dootdoot_core::{
    ...
    PITCH_SEMITONE_SPAN, PORTAMENTO_SECONDS, PUNCTUATION_GLIDE_SEMITONES, QUESTION_RISE_SEMITONES,
    RING_MOD_FREQUENCY_HZ, RING_MOD_MIX, SOURCE_PULSE_MIX, SOURCE_PULSE_WIDTH, SOURCE_SAW_MIX,
    SYNTH_SAMPLE_RATE_HZ, TRAILING_SILENCE_SAMPLES, TRAILING_SILENCE_SECONDS,
...
fn active_synthesis_constants_are_pinned() {
    ...
    // VOICE_V9 (R5): the question rise (4.5 st) is wider than the generic
    // punctuation glide (3.0 st) so the inquisitive lift is unmistakable.
