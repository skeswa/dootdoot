...
fn active_synthesis_constants_are_pinned() {
    ...
    // VOICE_V9 (R5): a question rises wider than any other mark's glide span so
    // the inquisitive lift is unmistakable.
    assert!(QUESTION_RISE_SEMITONES > PUNCTUATION_GLIDE_SEMITONES);
